...
import com.example.wordgame.adapter.Characters;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private String[] words = {"music", "abnormal", "softwarica", "musician", "alcoholic", "photosynthesis"};
...
//        });
    ...
    private void showWord(int i){
        Characters Character = new Characters(MainActivity.this,shuffleWords(i),etWord);
            ...
            case R.id.btnOK:
                ...
                if(level<words.length) {
                    if (usr_word.equals(words[level])) {
                        ...
                        editor.commit();
                        etWord.setText("");
                        Toast.makeText(MainActivity.this, "You've passes the level", Toast.LENGTH_SHORT).show();
